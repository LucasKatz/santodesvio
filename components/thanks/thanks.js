...
export default function ThanksContent() {
  ...
  return (
    <div className="max-w-md w-full border-2 border-[#F2A21B] p-8 text-center relative bg-[#121212] shadow-2xl">
      ...
      <Link
        href="/"
        className="inline-block w-full py-3 px-6 bg-[#F2A21B] text-black font-bold uppercase tracking-wider hover:bg-yellow-500 transition-colors duration-300 font-santo-alt cursor-pointer"
      >
